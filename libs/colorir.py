...
class Colorir():
    ...
    def anl_cor_especial(self, palavra, cor, lista):
        ...
        for linha in range(len(lista)):
            ...
            if palavra == "numerico":
                Colorir.marcar_coloracao_especial(
                    self,
                    '(^|\\s|\\,)([0-9\\.]\\s*){1,}($|\\s|\\,)',
                    lista,
                    linha,
                ...
                Colorir.marcar_coloracao_especial(self, '(#|\\/\\/).*$', lista, linha, palavra, cor)
                Colorir.marcar_coloracao_especial(self, '(\\/\\*[^\\*\\/]*\\*\\/)', lista, linha, palavra + "longo", cor)
    ...
    def coordena_coloracao(self, event, tx_codfc):
        ...
        try:
            ...
            Colorir.anl_cor_especial(self, 'numerico', self.cor_do_comando["numerico"], lista)
            Colorir.anl_cor_especial(self, 'comentario', self.cor_do_comando["comentario"], lista)
            Colorir.anl_cor_especial(self, '"', self.cor_do_comando["string"], lista)
