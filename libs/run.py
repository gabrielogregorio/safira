...
class Run():
    ...
    def interpretador(self, linha):
        ...
        if linha == '':
            ...
            if caractere_inicio in self.dicLetras["continue"]:
                analisa048 =Run.analisa_instrucao(self, '^(<continue>)$', linha)
                if analisa048[0]: return [Run.funcao_continuar(self), self.num_linha, ""]

            if caractere_inicio in self.dicLetras["pare"]:
                analisa048 =Run.analisa_instrucao(self, '^(<pare>)$', linha)
                if analisa048[0]: return [Run.funcao_parar(self), self.num_linha, ""]

            if caractere_inicio in self.dicLetras["interrompa"]:
                analisa048 =Run.analisa_instrucao(self, '^(<interrompa>)$', linha)
                if analisa048[0]: return [Run.funcao_interrompa(self), self.num_linha, ""]

            if caractere_inicio in self.dicLetras["mostreNessa"]:
                analisa001 =Run.analisa_instrucao(self, '^(<mostreNessa>)(.*)$', linha)
                if analisa001[0]: return [Run.funcao_exibir_mesma_ln(self, analisa001[1][2]), self.num_linha, "exibiçãoNaTela___.safira"]

            if caractere_inicio in self.dicLetras["mostre"]:
                analisa002 =Run.analisa_instrucao(self, '^(<mostre>)(.*)$', linha)
                if analisa002[0]: return [Run.funcao_exibir_outra_ln(self, analisa002[1][2]), self.num_linha, "exibiçãoNaTela___.safira"]

            if caractere_inicio in self.dicLetras["enquanto"]:
                analisa004 =Run.analisa_instrucao(self, '^(<enquanto>)(.*)$', linha)
                if analisa004[0]: return [Run.funcao_loops_enquantox(self, analisa004[1][2]), self.num_linha, "enquanto___.safira"]

            if caractere_inicio in self.dicLetras["aguarde"]:
                analisa005 =Run.analisa_instrucao(self, '^(<aguarde>)(.*)(<esperaEm>)$', linha)
                if analisa005[0]: return [Run.funcao_esperar_n_tempo(self, analisa005[1][2], analisa005[1][3]), self.num_linha, "esperar___.safira"]

            if caractere_inicio in self.dicLetras["repita"]:
                analisa006 =Run.analisa_instrucao(self, '^(<repita>)(.*)(<repitaVezes>)$', linha)
                if analisa006[0]: return [Run.funcao_repetir_n_vezes(self, analisa006[1][2]), self.num_linha, "repetir___.safira"]
            ...
            if caractere_inicio in self.dicLetras["digitado"]:
                ...
                if analisa020[0]: return [Run.funcao_ovalor_digitado(self, analisa020[1][1]), self.num_linha, "tudo_entradas___.safira"]
            ...
            if caractere_inicio in self.dicLetras["declaraListas"]:
                ...
                if analisa012[0]: return [Run.funcao_declarar_listas(self, analisa012[1][2], analisa012[1][4]), self.num_linha, "listas___.safira"]
            ...
            if caractere_inicio in self.dicLetras["RemoverItensListas"]:
                ...
                if analisa013[0]: return [Run.funcao_rem_itns_na_lst(self, analisa013[1][2], analisa013[1][4]), self.num_linha, "listas___.safira"]
            ...
            if caractere_inicio in self.dicLetras["adicionarItensListas"]:
                ...
                if analisa014[0]: return [Run.funcao_add_itns_lst_ps(self, analisa014[1][2], analisa014[1][4], analisa014[1][6]), self.num_linha, "listas___.safira"]

                analisa015 =Run.analisa_instrucao(self, '^(<adicionarItensListas>)(.*)(<addItensListaInternoFinal>)(.*)$', linha)
                if analisa015[0]: return [Run.funcao_add_itns_na_lst(self, analisa015[1][2], analisa015[1][4]), self.num_linha, "listas___.safira"]

                analisa016 =Run.analisa_instrucao(self, '^(<adicionarItensListas>)(.*)(<addItensListaInternoInicio>)(.*)$', linha)
                if analisa016[0]: return [Run.funcao_add_itns_lst_in(self, analisa016[1][2], analisa016[1][4]), self.num_linha, "listas___.safira"]

                analisa017 =Run.analisa_instrucao(self, '^(<adicionarItensListas>)(.*)(<addItensListaInterno>)(.*)$', linha)
                if analisa017[0]: return [Run.funcao_add_itns_na_lst(self, analisa017[1][2], analisa017[1][4]), self.num_linha, "listas___.safira"]

            if caractere_inicio in self.dicLetras["aleatorio"]:
                analisa018 =Run.analisa_instrucao(self, '^(<aleatorio>)(.*)(<aleatorioEntre>)(.*)$', linha)
                if analisa018[0]: return [Run.funcao_numer_aleatorio(self, analisa018[1][2], analisa018[1][4]), self.num_linha, "aleatorio___.safira"]
            ...
            if caractere_inicio in self.dicLetras["tiverLista"]:
                ...
                if analisa021[0]: return [Run.funcao_tiver_valor_lst(self, analisa021[1][2], analisa021[1][4]), self.num_linha, "se tiver___.safira"]
            ...
            if analisa023[0]: return [Run.funcao_realizar_atribu(self, analisa023[1][1], analisa023[1][3]), self.num_linha, "atribuicoes___.safira"]

            analisa024 =Run.analisa_instrucao(self, '^(.*)(<passandoParametros>)(.*)$', linha)
            if analisa024[0]: return [Run.funcao_executar_funcao(self, analisa024[1][1], analisa024[1][3]), self.num_linha, "funcoes___.safira"]
            ...
            return [  [False, "{}'{}'".format(  Run.msg_idioma(self, 'comando_desconhecido'), linha  ), 'string', 'fazerNada'], self.num_linha, ""]
    ...
    def comandos_uso_geral(self, possivelVariavel):
        ...
        if caractere_inicio in self.dicLetras["declaraListas"]:
             analisa048 =Run.analisa_instrucao(self, '^(<declaraListas>)(\\s*[a-zA-Z\\_0-9]*)$', possivelVariavel)
             if analisa048[0]: return Run.funcao_retornar_lista(self, analisa048[1][2])
        ...
        #if caractere_inicio in self.dicLetras["a_imagem_aparecer"]:
    ...
    def funcao_importe(self, biblioteca):
        ...
        resultadoOrquestrador =Run.orquestrador_interpretador_(self, teste[0])
    ...
    def funcao_add_lst_na_posi(self, variavelLista, posicao, valor):
        ...
        if posicao - 1 > len(self.dic_variaveis[variavelLista][0]):
            return [False, '{} {}'.format(Run.msg_idioma(self, "posicao_maior_limite_lista"), posicao),
                    'string', 'exibirNaTela']

        if posicao < 1:
            return [False, '{} {}'.format(Run.msg_idioma(self, "posicao_menor_limite_lista"), posicao),
                    'string', 'exibirNaTela']
    ...
    def funcao_add_itns_na_lst(self, valor, variavel):
        ...
        try:
            ...
            return [False, '"{}" {} "{}"!'.format(teste_valor[1],Run.msg_idioma(self, "nao_esta_na_lista"),
    ...
    def funcao_ovalor_digitado(self, linha):
        ...
        if 'numero ' in linha or 'number' in linha:
            try:
                ...
                return [False, '{} "{}"'.format(Run.msg_idioma(self, "digitou_caractere"), digitado),
                        'string', 'fazerNada']
            else:
    ...
    def funcao_repetir_n_vezes(self, linha):
        ...
        try:
            ...
            return [False, '{} "{}"'.format(Run.msg_idioma(self, "repetir_nao_informou_inteiro"), linha[1]),
                    'string', 'exibirNaTela']
        else:
    ...
    def funcao_executar_funcao(self, nomeDaFuncao, parametros=None):
        ...
        try:
            ...
            return [False,Run.msg_idioma(self, "funcao_nao_existe").format(nomeDaFuncao), 'string',
                    'exibirNaTela']
        ...
        if parametros is None:
            ...
            resultadoOrquestrador =Run.orquestrador_interpretador_(self, self.dic_funcoes[nomeDaFuncao]['bloco'])
        ...
        if testa != []:
            ...
            if len(self.dic_funcoes[nomeDaFuncao]['parametros']) == len(listaFinalDeParametros):
                ...
                for parametroDeclarar in range(len(self.dic_funcoes[nomeDaFuncao]['parametros'])):
                    resultado =Run.funcao_realizar_atribu(self, self.dic_funcoes[nomeDaFuncao]['parametros'][
                        parametroDeclarar], listaFinalDeParametros[parametroDeclarar])

                    if resultado[0] == False:
                        return [resultado[0], resultado[1], resultado[2], 'exibirNaTela']
            else:
                return [False,Run.msg_idioma(self, "funcao_tem_parametros_divergentes").format(nomeDaFuncao,
                                                                                                         len(
                                                                                                              listaFinalDeParametros)),
                        'string', 'fazerNada']
            ...
            if len(self.dic_funcoes[nomeDaFuncao]['parametros']) == 1:
                resultado =Run.funcao_realizar_atribu(self, self.dic_funcoes[nomeDaFuncao]['parametros'][0],
                                                                 parametros)

                if not resultado[0]: return [resultado[0], resultado[1], resultado[2], 'exibirNaTela']
            else:
                return [False,Run.msg_idioma(self, "funcao_passou_um_parametros").format(nomeDaFuncao, len(
                    self.dic_funcoes[nomeDaFuncao]['parametros'])), 'string', 'exibirNaTela']
    ...
    def fazer_contas(self, linha):
        ...
        try:
            ...
            return [False, "{} |{}|".format(Run.msg_idioma(self, "nao_possivel_fazer_conta"), linha[1]),
                    'string']
        else:
    ...
    def obter_valor_variavel(self, variavel):
        ...
        try:
            ...
            return [False, "{} '{}'".format(Run.msg_idioma(self, "voce_precisa_definir_variavel"), variavel),
                    'string', 'fazerNada']
        else:
    ...
    def abstrair_valor_linha(self, possivelVariavel):
        ...
        try:
            ...
            analisa044 =Run.analisa_instrucao(self, r'^\s*[a-z\_]*\s*$', possivelVariavel)
            if analisa044[0]:
    ...
    def funcao_testar_condicao(self, linha):
        ...
        try:
            ...
            return [False, "{} |{}|".format(Run.msg_idioma(self, "nao_possivel_fazer_condicao"), final),
                    'string', 'exibirNaTela']
